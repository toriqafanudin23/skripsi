...
\begin{enumerate}[leftmargin=1cm, label=\arabic*.]
    ...
    \begin{enumerate}[label=\arabic*)]
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.3\textwidth]{images2/simulasi3d.jpg}
            \includegraphics[width=0.3\textwidth]{images2/materi2.jpg}
            \includegraphics[width=0.3\textwidth]{images2/materi3.jpg}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.3\textwidth]{images2/ar1.jpg}
            \includegraphics[width=0.3\textwidth]{images2/ar2.jpg}
            \includegraphics[width=0.3\textwidth]{images2/ar3.jpg}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.3\textwidth]{images2/materi1.jpg}
        \includegraphics[width=0.3\textwidth]{images2/materi2.jpg}
        \includegraphics[width=0.3\textwidth]{images2/materi3.jpg}
    ...
    \item Halaman Kuis\\
    \hspace*{1cm}Kuis terdiri dari 5 soal, dengan tingkat kesulitan berjenjang. Peserta Didik akan diberikan pembahasan dan nilai akhir setelah mengerjakan kuis.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.25\textwidth]{images2/quizvolume.jpg}
