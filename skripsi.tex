...
\begin{center}
    {
        ...
        \textbf{PENGEMBANGAN MEDIA PEMBELAJARAN BERBASIS AUGMENTED REALITY PADA MATERI BANGUN RUANG SISI DATAR DI SMP NEGERI 3 KALIKAJAR}\\[1cm]
        \textbf{SKRIPSI}\\[1cm]
...
\begin{center}
    {
        ...
        \textbf{SKRIPSI}\\[0.4cm]
        \textbf{PENGEMBANGAN MEDIA PEMBELAJARAN BERBASIS AUGMENTED REALITY PADA MATERI BANGUN RUANG SISI DATAR DI SMP NEGERI 3 KALIKAJAR}\\[0.4cm]
    }
    {
        \fontsize{14pt}{16pt}\selectfont
...
\textbf{1. Ketua}      & \textbf{: Dr. Puguh Wahyu Prasetyo, S.Si., M.Sc. \dotfill} \\
\textbf{2. Penguji I}  & \textbf{: Dosen X} \\
\textbf{3. Penguji II} & \textbf{: Dosen Y}
\end{tabularx}
...
\hspace*{1cm}Pendidikan merupakan salah satu faktor utama dalam pembangunan suatu bangsa. Dalam upaya meningkatkan mutu pendidikan, diperlukan inovasi dalam metode pembelajaran yang mampu menjawab tantangan zaman serta memenuhi kebutuhan peserta didik. Salah satu tantangan yang sering dihadapi dalam pembelajaran matematika adalah kesulitan peserta didik dalam memahami konsep-konsep abstrak, khususnya pada materi bangun ruang sisi datar. Materi ini sering kali sulit dipahami karena umumnya hanya disampaikan melalui media dua dimensi, seperti buku teks atau gambar di papan tulis. Akibatnya, peserta didik mengalami kesulitan dalam memvisualisasikan bentuk tiga dimensi secara nyata \citep{battista1999}.

\hspace*{1cm}Kemajuan teknologi di era digital memberikan peluang besar untuk menghadirkan inovasi dalam dunia pendidikan. Salah satu teknologi yang memiliki potensi besar adalah Augmented Reality (AR) \citep{saidin2015}. Teknologi AR memungkinkan penggabungan objek virtual dengan dunia nyata secara interaktif dan realistis. Dalam konteks pembelajaran matematika, penggunaan AR diharapkan dapat meningkatkan kemampuan visualisasi, pemahaman, serta pengalaman belajar peserta didik terhadap materi bangun ruang \citep{syahputra2024}.
...
\hspace*{1cm}Penggunaan media pembelajaran berbasis Augmented Reality (AR) diharapkan dapat menjadi solusi yang efektif dalam mengatasi kesulitan yang dihadapi dalam pembelajaran matematika. AR sebagai alternatif media pembelajaran interaktif dapat meningkatkan pemahaman peserta didik terhadap konsep-konsep matematika, khususnya pada materi bangun ruang sisi datar \citep{nincarean2013mar,mustaqim2016pemanfaatan,qumillaila2017eksresi}. Media pembelajaran berbasis AR mengintegrasikan elemen digital dunia nyata dengan dunia maya, memungkinkan siswa memahami materi melalui visualisasi 3D, animasi, dan interaksi langsung yang meningkatkan keterlibatan mereka dalam proses pembelajaran, serta menunjukkan antusiasme dan partisipasi aktif yang lebih tinggi dibandingkan metode konvensional \citep{arinda2023}. Dengan memanfaatkan teknologi ini, diharapkan pemahaman peserta didik terhadap materi bangun ruang sisi datar dapat meningkat secara signifikan, sehingga hasil belajar pun menjadi lebih optimal.
...
\begin{enumerate}
    ...
    Penelitian ini diharapkan dapat memberikan kontribusi pengetahuan dalam bidang pendidikan matematika, khususnya terkait pengembangan media pembelajaran berbasis Augmented Reality.

    \item \textbf{Manfaat Praktis}
    \begin{enumerate}
        \item \textbf{Bagi Peserta Didik} \\
        Media ini diharapkan dapat mempermudah peserta didik dalam memvisualisasikan objek tiga dimensi, membantu memahami materi bangun ruang sisi datar, serta meningkatkan minat belajar matematika.
        
        \item \textbf{Bagi Pendidik} \\
        Media ini diharapkan dapat menjadi alternatif dalam menyampaikan materi bangun ruang sisi datar, serta menjadi motivasi dan rujukan bagi pendidik untuk mengembangkan media pembelajaran berbasis Augmented Reality pada materi lainnya.
    \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
    ...
    \hspace*{1cm}Pendidikan matematika merupakan disiplin ilmu di mana berbagai konsep dan topik digunakan secara intensif \citep{turkdogan2015}. Dalam konteks ini, penggunaan konsep-konsep di lapangan serta hubungan antar konsep menjadi komponen penting dalam dinamika bidang tersebut. Dengan pemahaman yang tepat terhadap komponen-komponen ini, pendidikan matematika memberikan perspektif baru bagi para peneliti, sehingga mereka dapat menelaah berbagai topik secara lebih mendalam, mengajukan pertanyaan-pertanyaan baru, dan bahkan menemukan kemungkinan-kemungkinan alternatif \citep{ernest2016}. Schoenfeld (2000) mengemukakan beberapa pertanyaan yang dieksplorasi dalam pendidikan matematika sebagai berikut:
    \begin{enumerate}
...
\hspace*{1cm}\citet{mulyatiningsih2012} menyatakan bahwa model ADDIE merupakan singkatan dari 
\textit{Analysis} (analisis), \textit{Design} (desain), \textit{Development} (pengembangan), 
\textit{Implementation} (implementasi), dan \textit{Evaluation} (evaluasi) yang dikembangkan oleh Dick and Carry. Berikut penjelasan dari masing-masing tahapan.
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{c c}
                ...
                \includegraphics[width=0.3\textwidth]{images/cover-sebelum.jpg} &
                \includegraphics[width=0.3\textwidth]{images/cover-sesudah.jpg} \\
            \end{tabular}
        \end{table}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.3\textwidth]{images/kubus-no-button.jpg}
        \end{figure}
        \item Menyisipkan teknologi AR pada soal, tidak hanya pada materi.
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.3\textwidth]{images/kuis3.jpg}
        \end{figure}
        \item Menambahkan materi mengenai unsur-unsur bangun ruang.
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.3\textwidth]{images/unsur-bangun.jpg}
        \end{figure}
        \item Memperbaiki penggunaan tanda baca pada kalimat-kalimat dalam media.
    \end{enumerate}
    \item Revisi Produk Hasil Validasi Ahli Media\\
    \hspace*{1cm}Berdasarkan masukan dari ahli media, perbaikan yang dilakukan telah sesuai dengan saran dan rekomendasi yang diberikan. Hasil perbaikan tersebut disajikan sebagai berikut.
    \begin{enumerate}
        \item Memperbaiki kunci jawaban.

        \begin{figure}[H]
            \centering
            \includegraphics[width=0.3\textwidth]{images/kunci-1.jpg}
            \hfill
            \includegraphics[width=0.3\textwidth]{images/kunci-2.jpg}
            \hfill
            \includegraphics[width=0.3\textwidth]{images/kunci-3.jpg}
            \caption{Contoh Perbaikan pada Kunci Jawaban}
        \end{figure}

        \item Membuat media mudah diakses oleh siswa.

        \hspace*{1cm}Media yang sebelumnya berupa aplikasi Android masih sulit untuk diakses oleh siswa, karena perangkat siswa yang belum memadai serta biaya unggah ke PlayStore yang cukup mahal. Oleh karena itu, media diubah menjadi bentuk web dengan konten yang sama. Hasil perubahan dapat diakses melalui: https://www.avanedu.my.id
    \end{enumerate}
